    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, mt: 8, width: { sm: `calc(100% - ${drawerWidth}px)` } }}>
        <Container maxWidth="xl">
          ...
          <Typography variant="h6" sx={{ mt: 4, mb: 2 }}>Completed Requests</Typography>
          {completedBookings.length === 0 ? (
            <Typography>No completed service requests.</Typography>
          ) : (
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell><strong>Service Description</strong></TableCell>
                    <TableCell><strong>Date</strong></TableCell>
                    <TableCell><strong>Booked Time Slot</strong></TableCell>
                    <TableCell><strong>Location</strong></TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
